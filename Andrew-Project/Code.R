...
pop_sep_length <- iris$Sepal.length
...
# If the sample mean (of setosa sepal lenghts) is 5.84 (the same as the pop mean),
# then .000000000000002% of the time, this difference (or more) 
# will happen by chance

### Activity :
#Choose a different numerica variable (sepal width, petal length, petal width) and
#compare any of the 3 species to the population mean (setosa, versicolor, or virginica)
...
#(mean of setosa sepal lenghts) - (mean of versicolor sepal lenghts) != 0
#mean of setosa sepal lengths != mean of versicolor sepal length
